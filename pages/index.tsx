  ...
  return (
    <div>
      ...
      <div className="">
        ...
        <section className="relative flex flex-col gap-3 pt-16 overflow-hidden section md:pt-28">
          ...
          <div className="flex flex-col gap-6 md:gap-12">
            <div className="flex flex-col items-center justify-center gap-4 h-fit lg:flex-row md:gap-12">
              <div className="flex flex-col flex-1 gap-4 overflow-hidden scale-75 ">
              ...
              <div className="flex flex-col items-center justify-center flex-1 gap-4 lg:items-start w-fit">
                ...
                <p className="mb-4 text-center md:text-lg lg:text-left lg:w-2/3">{cms?.whoWeAre?.text || "Eraskon Nigeria Limited (ENL) is an indigenous Security and Logistics services provider in the Oil & Gas and Marine sectors of the Nigerian economy with the vision of delivering top rated security services as required by clients while optimizing client’s profit and minimizing operational cost."}</p>
              </div>
            </div>
            <div className="flex flex-col items-center justify-center gap-4 lg:flex-row md:gap-12">
              <div className="flex flex-col flex-1 gap-4 overflow-hidden scale-75 lg:order-2 ">
